...
{
    [BehaviourTreeNode(menuPath = "Math/Float", menuName = "Subtract Integer", nodeTitle = "Float Math:\nSubtract Integer", nodeColor = NodeColors.green, nodeIcon = NodeIcons.action)]
    [System.Serializable]
